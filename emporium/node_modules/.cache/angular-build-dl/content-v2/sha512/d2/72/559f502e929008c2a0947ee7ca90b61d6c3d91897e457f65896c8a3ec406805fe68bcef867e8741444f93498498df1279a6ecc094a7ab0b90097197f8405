...
AgmOverlay.ɵfac = function AgmOverlay_Factory(t) { return new (t || AgmOverlay)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_agm_core__WEBPACK_IMPORTED_MODULE_2__["GoogleMapsAPIWrapper"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_agm_core__WEBPACK_IMPORTED_MODULE_2__["MarkerManager"])); };
AgmOverlay.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: AgmOverlay, selectors: [["agm-overlay"]], contentQueries: function AgmOverlay_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
    ...
    } }, inputs: { visible: "visible", zIndex: "zIndex", openInfoWindow: "openInfoWindow", draggable: ["markerDraggable", "draggable"], latitude: "latitude", longitude: "longitude", bounds: "bounds" }, outputs: { markerClick: "markerClick" }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵNgOnChangesFeature"]], ngContentSelectors: _c1, decls: 4, vars: 0, consts: [["content", ""], [2, "position", "absolute"]], template: function AgmOverlay_Template(rf, ctx) { if (rf & 1) {
...
AgmOverlays.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({ type: AgmOverlays });
AgmOverlays.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AgmOverlays_Factory(t) { return new (t || AgmOverlays)(); }, imports: [[
            _angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"]
        ]] });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AgmOverlay, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"],
        args: [{
                selector: "agm-overlay",
                template: '<div #content><div style="position:absolute"><ng-content></ng-content></div></div>'
            }]
    }], function () { return [{ type: _agm_core__WEBPACK_IMPORTED_MODULE_2__["GoogleMapsAPIWrapper"] }, { type: _agm_core__WEBPACK_IMPORTED_MODULE_2__["MarkerManager"] }]; }, { visible: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AgmOverlays, { declarations: function () { return [AgmOverlay]; }, imports: function () { return [_angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"]]; }, exports: function () { return [AgmOverlay]; } }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AgmOverlays, [{
...
//# sourceMappingURL=default~pages-ordertrack-ordertrack-module~pages-userloc-userloc-module-es2015.js.map