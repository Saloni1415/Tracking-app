...
export const routes: Routes = [
    { 
        ...
        component: PagesComponent, children: [
            ...
            { path: 'ordertrack', loadChildren: () => import('./pages/ordertrack/ordertrack.module').then(m => m.OrdertrackModule), data: { breadcrumb: 'ordertrack' } },
            { path: 'track', loadChildren: () => import('./pages/driverpublish/driverpublish.module').then(m => m.DriverpublishModule), data: { breadcrumb: 'track' } },
           { path: 'userloc', loadChildren: () => import('./pages/userloc/userloc.module').then(m => m.UserlocModule), data: { breadcrumb: 'usertrack' } },
           { path: 'catalog', loadChildren: () => import('./pages/catalog/catalog.module').then(m => m.CatalogModule), data: { breadcrumb: 'catalog' } },
        ]
    },
