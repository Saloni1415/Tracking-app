...
@Component({
  ...
  templateUrl: './prod-zoom.component.html',
  styleUrls: ['./prod-zoom.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ProdZoomComponent implements OnInit {
  
  @ViewChild('zoomImage', { static: true }) zoomImage;

  constructor(public dialogRef: MatDialogRef<ProdZoomComponent>,
